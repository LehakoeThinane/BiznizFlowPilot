...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/invoices",        label: "Invoices",        icon: "invoices",        roles: ["owner", "manager"] },
    ],
  },
  {
    heading: "Finance & HR",
    items: [
      { href: "/finance",   label: "Finance",   icon: "finance",   roles: ["owner", "manager"] },
      { href: "/employees", label: "Employees", icon: "employees", roles: ["owner", "manager"] },
      { href: "/leave",     label: "Leave",     icon: "leave",     roles: ["owner", "manager", "staff"] },
      { href: "/payroll",   label: "Payroll",   icon: "payroll",   roles: ["owner", "manager"] },
    ],
  },
  {
    heading: "Automation",
